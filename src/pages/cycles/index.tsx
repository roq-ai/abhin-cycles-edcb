...
type ColumnType = ColumnDef<CycleInterface, unknown>;

interface CycleListPageProps {
...
export function CycleListPage(props: CycleListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<CycleInterface>>(
    () => `/cycles?params=${JSON.stringify(params)}`,
    fetcher,
  );
      ...
      : null,
    {
      ...
      cell: ({ row: { original: record } }: any) => (
        <Flex justifyContent="flex-end">
          <NextLink href={`/cycles/view/${record.id}`} passHref legacyBehavior>
            <Button
